...
<form action="" method="post">
            ...
            <textarea class="input-text text-area" cols="0" rows="0" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;" name="content">Nội dung *</textarea>
            <input class="input-btn" type="submit" value="Gửi" name="btn_send">

</div>
</div>
</div>
</div>
<script type="text/javascript" src="dadbab.info/content/shared/js/js.cookie.min.js"></script>
<script>
...
<script type="text/javascript" src="dadbab.info/content/shared/js/sender.min.js"></script>
    ...
    (function () {
        ...
        window.get_params = function () {
            return updateObject(getURLParams(), {
                'offer_id': parseInt('7000'),
                'safe_uid': 'b111257ce5ebbaacc2f152e90c1a2b33',
                'preland_id': parseInt('13591'),
                'slave_prefix_id': 'hk2',
                'country_code': 'vn',
                'browser_locale': 'en',
...
<script>
    document.addEventListener('plgload', function () {
        ...
        img.src = 'xl-trk.com/trackd41d.html?' +
            'a=' + source +
            '&b=' + stamp +
            '&c=' + acrum_extra.type +
...
<script>
	...
	var src = 'cdn.tomono.com/pixel/land.bundle.min77e6.js?time='+time;
